...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <div class="social-links">
        ...
        <a href="https://www.linkedin.com/in/atul-upadhyay/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        <a href="https://join.skype.com/invite/USdqRITwjU2m" target="_blank" class="google-plus"><i class="bx bxl-skype"></i></a>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About Me</h2>
          <p>Hi There, I’m Atul and I'm Front-End and Back-End Web Developer. It's been 2 years, I’m working as web developer. I have developed many website.</p>
        </div>

        <div class="row">
          <div class="col-lg-4">
            <img src="assets/img/atulpr.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            <h3> Web Developer.</h3>
            <p class="font-italic">
              New challenging responsibilities and to serve a reputed growth-oriented industry in the field of Design, Development, and Maintenance.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> atulupadhyay50003@gmail.com</li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">PHP / FramWork <i class="val">95%</i></span>
              <div class="progress-bar-wrap">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="#">Static Website</a></h4>
              <p>A static website contains Web pages with fixed content.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <p>It allows users to interact with the information that is listed on the page.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">CMS Website</a></h4>
              <p>A CMS website is an application that is used to manage web content.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>atulupadhyay50003@gmail.com</p>
              </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>Atul Upadhyay</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
